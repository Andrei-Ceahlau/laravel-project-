...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Ajustează stoc</h1>
    </div>
    ...
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Ajustează stoc</li>
        </ol>
    </nav>
        ...
        <div class="col-lg-8">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Ajustează stoc pentru "{{ $product->name }}"</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('products.update-adjust-stock', $product->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="quantity" class="form-label">Cantitate de scăzut</label>
                                    <div class="input-group">
                                        <input type="number" min="1" max="{{ $product->stock }}" class="form-control @error('quantity') is-invalid @enderror" id="quantity" name="quantity" value="{{ old('quantity', 1) }}" required>
                        ...
                        <div class="mb-4">
                            <label for="reason" class="form-label">Motivul ajustării</label>
                            <select class="form-select @error('reason') is-invalid @enderror" id="reason" name="reason" required>
                                ...
                                <option value="Deteriorat">Produs deteriorat</option>
                                <option value="Expirat">Produs expirat</option>
                                <option value="Returnare">Returnare furnizor</option>
                                <option value="Eroare inventar">Eroare inventar</option>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-warning">Ajustează stoc</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-warning mt-4" role="alert">
                        <i class="fas fa-exclamation-triangle me-2"></i> Ajustarea stocului va reduce cantitatea disponibilă pentru vânzare.
                    </div>
                    
                    <a href="{{ route('products.show', $product->id) }}" class="btn btn-outline-secondary btn-sm w-100 mt-2">
